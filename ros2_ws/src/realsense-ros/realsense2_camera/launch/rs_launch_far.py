...
"""Launch realsense2_camera node for camera3 (332522076393)."""
import os
import yaml
...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera3', 'description': 'camera unique name'},
                           {'name': 'camera_namespace',             'default': 'camera', 'description': 'namespace for camera'},
                           {'name': 'serial_no',                    'default': "'332522076393'", 'description': 'choose device by serial number'},
